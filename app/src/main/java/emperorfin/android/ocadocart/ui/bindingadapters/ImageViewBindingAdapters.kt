...
@BindingAdapter(value = ["bindProductOverviewImageUrl", "bindImageWidth", "bindImageHeight"], requireAll = false)
fun setProductOverviewImageUrl(imageView: ImageView, imageUrl: String?, iconWidth: Int?, iconHeight: Int?){
    imageUrl?.let {
